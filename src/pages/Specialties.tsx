      ...
      <div className="bg-indigo-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 max-w-2xl mx-auto text-lg">
            Elige tu camino profesional y descubre un mundo de oportunidades.
          </p>
        </div>
      </div>
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group block bg-white rounded-[2.5rem] p-10 border border-slate-200 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/10 transition-all text-center"
                >
                  <div className={cn(
